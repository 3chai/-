...
presets = {
    ...
    "A-1 Pictures": {
        "first_frame_top_y_true": 797,
        "frame_height_true": 22.57,
        "cell_x_positions_true": {cell: 74.42 + 28.85 * offset for cell, offset in cell_offsets.items()},
        "column_offset_x": 855.36,
        "true_width": 1754,
        "true_height": 2480,
        "default_book_koma": 6,
        "default_celllabel_koma": 2,
    ...
    "Bibury": {
        ...
        "frame_height_true": 47.25,
        "cell_x_positions_true": {cell: 105 + 55  * offset for cell, offset in cell_offsets.items()},
        "column_offset_x": 1705,
        "true_width": 3508,
        "true_height": 4961,
        "default_book_koma": 5,
        "default_celllabel_koma": 1
    ...
    "サイエンスSARU": {
        ...
        "cell_x_positions_true": {cell: 42.5 + 29.7 * offset for cell, offset in cell_offsets.items()},
        "column_offset_x": 850,
        "true_width": 1754,
        "true_height": 2480,
        "default_book_koma": 4,
